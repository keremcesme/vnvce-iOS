...
extension UIColor {
    ...
    static var offWhiteOrBlack2: UIColor {
        if #available(iOS 13, *) {
            return UIColor { (traitCollection: UITraitCollection) -> UIColor in
                let rgbValue: CGFloat = traitCollection.userInterfaceStyle == .dark ? 60 : 200
                return UIColor(r: rgbValue, g: rgbValue, b: rgbValue)
            }
        } else {
            return UIColor(r: 247, g: 247, b: 247, a: 0.05)
        }
    }
    ...
    static var containerOverlay: UIColor {
        return .black
    }
