...
class YPAssetViewContainer: UIView {
    ...
    override func awakeFromNib() {
        ...
        curtain.backgroundColor = UIColor.containerOverlay.withAlphaComponent(0.7)
        curtain.alpha = 0
        
        if !onlySquare {
            // Crop Button
            if #available(iOS 13.0, *) {
                squareCropButton.setImage(UIImage(systemName: "arrow.down.right.and.arrow.up.left", withConfiguration: UIImage.SymbolConfiguration(pointSize: 24, weight: .light))?.withTintColor(UIColor(r: 255, g: 255, b: 255, a: 1), renderingMode: .alwaysOriginal), for: .normal)
                squareCropButton.layer.shadowColor = UIColor.black.cgColor
                squareCropButton.layer.shadowRadius = 6.0
                squareCropButton.layer.shadowOpacity = 0.3
            }
