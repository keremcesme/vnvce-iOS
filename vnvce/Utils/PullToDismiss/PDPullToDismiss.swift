...
open class PDPullToDismiss: NSObject {
    ...
    open var backgroundEffect: PDBackgroundEffect? = PDShadowEffect.default
    open var edgeShadow: PDEdgeShadow? = PDEdgeShadow.default
    ...
    public weak var delegate: UIScrollViewDelegate? {
        didSet {
            ...
            proxy = PDScrollViewDelegateProxy(delegates: delegates)
        }
    }
    ...
    private var proxy: PDScrollViewDelegateProxy? {
        didSet {
    ...
    public init(scrollView: UIScrollView, viewController: UIViewController, navigationBar: UIView? = nil) {
        super.init()
        self.proxy = PDScrollViewDelegateProxy(delegates: [self])
...
extension PDPullToDismiss: UITableViewDelegate {
}

extension PDPullToDismiss: UICollectionViewDelegate {
}

extension PDPullToDismiss: UICollectionViewDelegateFlowLayout {
}

extension PDPullToDismiss: UIScrollViewDelegate {
